...
# Form implementation generated from reading ui file 'footprint_plus.ui'
#
...
from contrastpic import newWnd
import numpy as np
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(690, 130, 281, 241))
        self.groupBox_3.setObjectName("groupBox_3")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.groupBox_3)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 261, 211))
        ...
        self.pushButton_5.setMaximumSize(QtCore.QSize(230, 25))
        ...
        self.label_4.setMaximumSize(QtCore.QSize(82, 20))
        ...
        self.pushButton_3.setMinimumSize(QtCore.QSize(230, 25))
        self.pushButton_3.setMaximumSize(QtCore.QSize(230, 25))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(9, 19, 261, 221))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 241, 32))
        ...
        self.label_9.setMinimumSize(QtCore.QSize(65, 20))
        self.label_9.setMaximumSize(QtCore.QSize(65, 20))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 0, 241, 31))
        ...
        self.label_16.setMinimumSize(QtCore.QSize(65, 20))
        self.label_16.setMaximumSize(QtCore.QSize(65, 20))
        ...
        self.radioButton_3.setMinimumSize(QtCore.QSize(55, 0))
        ...
        self.radioButton_4.setMinimumSize(QtCore.QSize(55, 0))
        ...
        self.label_10.setMinimumSize(QtCore.QSize(65, 20))
        ...
        self.radioButton_2.setMinimumSize(QtCore.QSize(55, 0))
        ...
        self.radioButton_5.setMinimumSize(QtCore.QSize(55, 0))
        ...
        self.pushButton_6.setMinimumSize(QtCore.QSize(240, 30))
        self.pushButton_6.setMaximumSize(QtCore.QSize(240, 20))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "标注打印纸张"))
        self.radioButton_6.setText(_translate("Form", "A3")) #标注A3
        self.radioButton.setText(_translate("Form", "A4"))  #标注A4
   ...
   # 单文件处理
    ...
    def pushButton3Clicked_anno(self):
        ...
        if self.radioButton_6.isChecked():
            format = "A3"
        if format == "A4" and radio>=1: #创建一个A4文件夹存放截取后的图片 更新images的路径
            contrast_images = [] #对比图片路径
            for img_path in images:
                p, f = os.path.split(img_path)
                if not "contrast" in f: #单一图片
                    img = cv2.imdecode(np.fromfile(img_path, dtype=np.uint8),1)
                ...
                else: contrast_images.append(img_path)
                single_images = glob.glob(self.save_dir + "analyseFile/A4/" +"*.[jp][pn]g") if os.path.exists(self.save_dir + "analyseFile/A4/") else []
                images = single_images+contrast_images
        ...
        if not os.path.exists(self.save_dir + "analyseFile"):
            ...
            imagesTodocx(images, docx_path, w=181, radio=radio, format=format) #181表示181mm宽
