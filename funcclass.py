...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_6.setText(_translate("Form", "长度颜色选择"))
        self.pushButton_3.setText(_translate("Form", "角度测量"))
        self.pushButton_7.setText(_translate("Form", "角度颜色选择"))
    ...
    def getSingleImage(self):
        ...
        # pic_scaled = pic_image.scaled(img_width, img_height, aspectRatioMode=Qt.IgnoreAspectRatio) #KeepAspectRatio
        # self.lab.setPixmap(pic_scaled)
        # self.lab.setMinimumSize(self.img_width, self.img_height)

        # 载入图片
        Qimage = QImage()
        Qimage.load(str(self.pic_path))
        # 旋转变换
    ...
    def saveImage(self):
        ...
        pic_name = os.path.basename(self.pic_path)
...
if __name__ == "__main__":
    ...
    mainWindow = newWnd(filepath="./data/result")
    mainWindow.show()
    sys.exit(app.exec_())